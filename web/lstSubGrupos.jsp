...
<%
    ...
    List lstG = servicio.listarSubgrupos();
...
<table width="75%" border="0" cellspacing="1" cellpadding="1">
  <tr>
    ...
    <td width="24%">GRUPO</td>
  </tr>
      <% if(lstG!=null){ 
    for(java.util.Iterator it = lstG.iterator(); it.hasNext();)  {
        Subgrupos grp = (Subgrupos)it.next();
          %>
  <tr>
    <td><%=grp.getNombre()%>;</td>
    <td><%=grp.getDescripcion()%></td>
    <td><%=grp.getGruposId().getNombre() %></td>
  </tr>
      <% }} %>
</table>
<p><a href="subgrupos.jsp">AGREGAR</a></p>
